...
def pipeline(args):
    ...
    experiment_tag = f"GFDT_{timestamp}_{args.seed}"
    save_path = f'seed{args.seed}_dql/{args.pipeline_name}/{args.task.env_name}/{experiment_tag}/'
    ...
    # ---------------------- Training ----------------------
    if args.mode == "train":
        folder_path=f'seed123_dql/{args.pipeline_name}/{args.task.env_name}/pretrained/'
