...
@hydra.main(config_path="../configs/dql/adroit_exp005", config_name="adroit", version_base=None)
def pipeline(args):
    set_seed(args.seed)

    save_path = f'results/{args.pipeline_name}/{args.task.env_name}/'
    fallback_dir = f'results/{args.pipeline_name}/{args.task.env_name}/pretrained'
