...
@hydra.main(config_path="../configs/dql/adroit_clone", config_name="adroit", version_base=None)
def pipeline(args):
    ...
    if args.mode == "train":
        ...
        for batch in loop_dataloader(dataloader):
            ...
            target_q1 = target_q1.view(-1, 10, 1).mean(1)
            target_q2 = target_q2.view(-1, 10, 1).mean(1)
